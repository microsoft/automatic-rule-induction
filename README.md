...
This repo contains an implementation of the Automatic Rule Induction framework. See the paper for details: [link](https://arxiv.org/pdf/2205.09067.pdf).
...
Train a default model on the `sms` dataset:
